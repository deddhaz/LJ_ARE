...
SELECT
    ...
    -- Course Level
    CASE 
        WHEN rq.title LIKE '%Learning Journey ARE : Intermediate Course Lv I %' THEN 'Intermediate Course Level 1'
        WHEN rq.title LIKE '%Learning Journey ARE : Intermediate Course Lv II%' THEN 'Intermediate Course Level 2'
        WHEN rq.title LIKE '%Learning Journey ARE : Advance Course Lv I %'      THEN 'Advance Course Level 1'
        WHEN rq.title LIKE '%Learning Journey ARE : Advance Course Lv II%'      THEN 'Advance Course Level 2'
        WHEN rq.title LIKE '%Learning Journey SPV Agency : Intermediate Course%' THEN 'Intermediate Course'
        WHEN rq.title LIKE '%Learning Journey SPV Agency : Advance Course%'      THEN 'Advance Course'
...
ORDER BY rq.title ASC, rq.username ASC;
